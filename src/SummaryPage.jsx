...
export default function App({ setNewSummary, currSummary }) {
    ...
    return (
        <>
            <div className='w-5/6 justify-center text-center items-center flex flex-col p-5'>
                ...
                <div className="flex flex-row w-full p-4 gap-4">
                    <div className="flex flex-col w-1/3 gap-4">
                        <input
                            ...
                            placeholder='Enter a high level summary'
                        ...
                        <input
                            type="text"
                            onChange={e => setUserAreaPrompt(e.target.value)}
                            placeholder='Target user group'
                            className="text-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        />
                        <button
                            onClick={() => getAIResponse(
                                "You're an assistant to a product manager, they're going to provide you a high level overview of a new product you're building a PRD for. Expand to a maximum of 80 words, be concise and technical where necessary. The last line can have a small amount of flourish. You should further consider the product is aimed at the following target user group " + userAreaPrompt + " and amend the response as such.",
                                summaryPrompt,
                                UpdateSummary
                            )}
