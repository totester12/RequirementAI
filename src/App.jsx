...
function App() {
  ...
  return (
    ...
    <div class='mainDiv absolute top-0 z-[-2]  min-h-screen w-full bg-neutral-950 bg-[radial-gradient(ellipse_70%_80%_at_50%_-10%,rgba(10,119,198,0.3),rgba(255,255,255,0))]  '>
      <div >
