...
function App() {
  ...
  return (
    ...
    <div class='mainDiv bg-regal-blue w-full h-screen'>
      <p class="p-10 text-6xl font-bold tracking-tight bg-transparent flex flex-row justify-center">
        Create PRD Templates using  <p class="pl-4 bg-transparent font-extrabold bg-gradient-to-bl  from-blue-600 via-teal-500 to-amber-400  bg-clip-text text-transparent "> GenAI</p>
      </p>
